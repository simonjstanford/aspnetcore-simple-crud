...
namespace SimpleCrudSite.Models
{
    public class DataSource
    {
        ...
        static DataSource() {
            ...
            _products.Add(1, new Product { ID = 1, Name = "Learning C#", TypeID = 1, Price = 9.99M });
            _products.Add(2, new Product { ID = 2, Name = "Learning Java", TypeID = 1, Price = 9.99M });
            _products.Add(3, new Product { ID = 3, Name = "Learning Python", TypeID = 1, Price = 9.99M });
            _products.Add(4, new Product { ID = 4, Name = "Apple", TypeID = 2, Price = 0.99M });
            _products.Add(5, new Product { ID = 5, Name = "Banana", TypeID = 2, Price = 0.99M });
            _products.Add(6, new Product { ID = 6, Name = "Orange", TypeID = 2, Price = 0.99M });
        }
